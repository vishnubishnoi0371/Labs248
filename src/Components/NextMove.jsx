...
const NextMove = () => {
  return (
    <div className="bg-black pt_75 mt_2 position-relative overflow-hidden">
      ...
      <div className="container">
        ...
        <div className="row flex-column-reverse flex-md-row justify-content-center align-items-center justify-content-md-between pb_75">
          <div data-aos="zoom-in" className="col-xl-3  col-12">
            <div className="d-flex flex-column flex-md-row flex-xl-column align-items-center gap-4 mb-3 justify-content-center justify-content-xl-start">
              <button className="text-white domain-bt s5-btn1 fw-bold fs-18 lh_27">
                name@domain.com
              </button>
          ...
          <div data-aos="zoom-in" className="col-xl-8 col-12">
            <p className="fs-16 text-center text-xl-start fw-normal lh_24 text-white-2 mb-3">
        ...
        <div className="pt_75 position-relative">
          ...
          <h1
            data-aos="zoom-in"
            className="fs-52 lh_62 fw-bold text-white mx-auto text-center mb-4 pb-1"
          >
          ...
          <img
            ...
            alt="rich-img"
          />
          <p className="fs-16 lh_24 fw-normal text-white op_70 text-center mb-0 mt-3 pt-2">
